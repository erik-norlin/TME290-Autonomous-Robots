...
class SingleTrackModel {
 ...
 public:
  ...
  void set_wL(opendlv::proxy::AxleAngularVelocityRequest const &) noexcept;
  void set_wR(opendlv::proxy::AxleAngularVelocityRequest const &) noexcept;

 private:
  float m_longitudinalSpeed;
