...
class LIB_API Geolocation {
    ...
    public:
        inline Geolocation& latitude(const float &v) noexcept {
            m_latitude = v;
            return *this;
        }
        inline float latitude() const noexcept {
            return m_latitude;
        }
        inline Geolocation& longitude(const float &v) noexcept {
            m_longitude = v;
            return *this;
        }
        inline float longitude() const noexcept {
            return m_longitude;
        }
